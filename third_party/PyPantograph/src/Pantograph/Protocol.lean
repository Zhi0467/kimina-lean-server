...
structure GoalStepBatchItem where
  itemIdx : Nat
  parentPath : System.FilePath
...
structure GoalStepBatchAttemptResult where
  ...
  tactic : String
  status : String
  childPath? : Option System.FilePath := .none
  goals : Array Goal := #[]
...
structure GoalStepBatchItemResult where
  itemIdx : Nat
  results : Array GoalStepBatchAttemptResult := #[]
  deriving ToJson

structure GoalStepBatchResult where
  items : Array GoalStepBatchItemResult := #[]
  deriving ToJson
