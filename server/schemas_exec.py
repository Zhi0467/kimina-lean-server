...
from lean_client.exec_models import (
    ...
    ExecDebugInfo as ExecDebugInfo,
    ExecDiagnostics as ExecDiagnostics,
    ...
    ExecMessage as ExecMessage,
    ExecMessageSeverity as ExecMessageSeverity,
    ...
    ExecVerifyItem as VerifyItem,
    ExecVerifyRequest as VerifyRequest,
    ExecVerifyResponse as VerifyResponse,
    ExecVerifyResult as VerifyResult,
    ExecVerifyStatus as ExecVerifyStatus,
